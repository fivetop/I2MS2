...
namespace I2MS2
{
    ...
    /// </summary>
    public class AssetPrintListProvider : IItemsProvider<AssetPrintList>
    {
        private readonly int _count;
        private readonly int _fetchDelay;
        private List<AssetPrintList> list1;
        ...
        public AssetPrintListProvider(int count, int fetchDelay)
        {
            _count = count;
            _fetchDelay = fetchDelay;
        }

        public AssetPrintListProvider(int p1, int p2, List<AssetPrintList> list1)
        {
        ...
        /// <returns></returns>
        public IList<AssetPrintList> FetchRange(int startIndex, int count)
        {
            Trace.WriteLine("FetchRange: " + startIndex + "," + count);
            Thread.Sleep(_fetchDelay);

            List<AssetPrintList> list = new List<AssetPrintList>();
            ...
            try
            {
                ...
                if (t1 > _count)
                {
                    ...
                    {
                        AssetPrintList customer = new AssetPrintList { RowNumber = i };
                        list.Add(customer);
