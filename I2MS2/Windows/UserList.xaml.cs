...
namespace I2MS2.Windows
{
    ...
    public partial class UserList : Window
    {
        ...
        private void initListView()
        {
            ...
            _listHeader.Add(new listHeader { h_width = 60, h_title = "C_Info46", h_bind = "use_sms" });
            _listHeader.Add(new listHeader { h_width = 150, h_title = "M9_Contact_Email", h_bind = "email" });
            _listHeader.Add(new listHeader { h_width = 60, h_title = "C_Info47", h_bind = "use_email" });
            ...
            for (int row = 0; row < _print_list.Count; row++)
            {
                ...
                for (int i = 0; i < _lvcompare.Count; i++)
                {
                    ...
                    switch (t1.newid)
                    {
                        ...
                        case 5: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.phone)))); break;
                        case 6: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.mobile)))); break;
                        case 7: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.use_sms)))); break;
                        case 8: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.email)))); break;
                        case 9: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.use_email)))); break;
                    }
                }
            }
