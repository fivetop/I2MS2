...
namespace I2MS2.Chart
{
    ...
    public class AnimatedMasonryControl : MasonryControl
    {
        ...
        public static readonly DependencyProperty AnimationManagerProperty =
            DependencyProperty.Register("AnimationManager", typeof(AnimationManager), typeof(AnimatedMasonryControl));
        ...
        public AnimationManager AnimationManager 
        {
            get
            {
                return (AnimationManager)this.GetValue(AnimationManagerProperty);
            }
            set
            {
                this.SetValue(AnimationManagerProperty, value);
            }
        }
