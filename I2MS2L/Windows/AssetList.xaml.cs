    ...
    public partial class AssetList : Window
    {
        ...
        private void getDBList2()
        {
            ...
            var tdb3 = from apl in g.catalog_group_list
                       where (apl.catalog_level == 2 && apl.catalog_group_id != 3210 && apl.catalog_group_id != 3220 && apl.catalog_group_id != 3230 && apl.catalog_group_id != 3460 && apl.catalog_group_id != 3470 && apl.catalog_group_id != 3150)
        ...
        private void getDBList()
        {
            ...
            var tdb1 = from a in g.asset_list
                       ...
                       select new AssetPrintList()
                       {
                           ...
                           RowNumber = i++,
                           last_updated_string = a.last_updated.GetDateTimeFormats().GetValue(76).ToString(),
        ...
        private void initListView()
        {
            ...
            switch (cboType.SelectedIndex)
            {
                case 0:
                    ...
                    _listHeader.Add(new listHeader { h_width = 100, h_title = "M9_Asset_Installer", h_bind = "install_user_name" });
//                    _listHeader.Add(new listHeader { h_width = 100, h_title = "M_Prop4_1_InstallDate", h_bind = "install_date" });
                ...
                case 1:
                    ...
                    _listHeader.Add(new listHeader { h_width = 0, h_title = "M9_Asset_Installer", h_bind = "install_user_name" });
...
//                            ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(temp)))); break;
                        case 14: temp = mp.as_free_start_date != null ? mp.as_free_start_date.Value.ToShortTimeString() : ""; 
                            ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(temp)))); break;
                        case 15: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.as_free_duration.ToString())))); break;
                        case 16: temp = mp.as_free_end_date != null ? mp.as_free_end_date.Value.ToShortTimeString() : ""; 
                            ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(temp)))); break;
                        case 17: temp = mp.as_start_date != null ? mp.as_start_date.Value.ToShortTimeString() : ""; 
                            ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(temp)))); break;
                        case 18: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.as_duration.ToString())))); break;
                        case 19: temp = mp.as_end_date != null ? mp.as_end_date.Value.ToShortTimeString() : ""; 
                            ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(temp)))); break;
                        case 20: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.as_price.ToString())))); break;
                        case 21: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.as_company)))); break;
                        case 22: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.bu_purchase_date)))); break;
                        case 23: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.bu_purchase_user_name)))); break;
                        case 24: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.bu_depreciation_start_year.ToString())))); break;
                        case 25: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.bu_depreciation_duration.ToString())))); break;
                        case 26: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.bu_depreciation_end_year.ToString())))); break;
                        case 27: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.snmp_get_community == null ? "" : mp.snmp_get_community)))); break;
                        case 28: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.snmp_set_community == null ? "" : mp.snmp_set_community)))); break;
                        case 29: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.snmp_version == null ? "" : mp.snmp_version)))); break;
                        case 30: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.last_updated_string)))); break;
                    }
                }
            }
...
//            string serial2 = txt_serial2.Text.ToString().Trim();
            ...
            // GS_DEL
            // where (a.location_id != 0) 
                     //  where (a.location_id != 0) && (b.catalog_group_id == 3410 || b.catalog_group_id == 3420 || b.catalog_group_id == 3430 || b.catalog_group_id == 3440 || b.catalog_group_id == 3130)
