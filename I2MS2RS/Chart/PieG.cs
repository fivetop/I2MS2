...
namespace I2MS2.Chart
{
    public class PieG : ItemsControl
    {
        ...
        public static readonly DependencyProperty SetvalueorgProperty;
        public static readonly DependencyProperty Setvalue100Property;
        public static readonly DependencyProperty BorderBrush2Property;

        [Bindable(true)]
        public double Setvalueorg
        {
            get { return (double)GetValue(PieG.SetvalueorgProperty); }
            set {
                base.SetValue(PieG.SetvalueorgProperty, value);
                Setvalue100 =  value *2;
            }
        }

        [Bindable(true)]
        public double Setvalue100
        {
            get { return (double)GetValue(PieG.Setvalue100Property); }
            set { base.SetValue(PieG.Setvalue100Property, value); }
        }
...
//                bl1.Add((Brush)props[i].GetValue(null, null));
            ...
            for (int i = 1; i < 60; i++)
            {
                string s = String.Format("__color{0:00}", i);
            ...
            PieG.InnerRadiusProperty = DependencyProperty.Register("InnerRadius", typeof(double), typeof(PieG), new FrameworkPropertyMetadata(100.0));
            ...
            PieG.SetvalueorgProperty = DependencyProperty.Register("Setvalueorg", typeof(double), typeof(PieG), new FrameworkPropertyMetadata(5.0, OnValue));
            PieG.Setvalue100Property = DependencyProperty.Register("Setvalue100", typeof(double), typeof(PieG), new FrameworkPropertyMetadata(5.0));
        ...
        private void DrawMenu(ItemsControl items_control, int level, double angle, double sector, DrawingContext drawingContext)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                Brush border_brush = Brushes.LightGray; //this.BorderBrush2;
...
//                drawingContext.DrawGeometry(background_brush, new Pen(border_brush, menu_item.BorderThickness.Left), geometry);
        ...
        public void DoubleAnimation_Start()
        {
            ...
            this.BeginAnimation(PieG.SetvalueorgProperty, MyDoubleAnimation);
        }
        ...
        void MyDoubleAnimation_Completed(object sender, EventArgs e)
        {
            ...
            MyDoubleAnimation.To = Setvalueorg;
