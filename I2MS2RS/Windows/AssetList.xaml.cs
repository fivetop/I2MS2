    ...
    public partial class AssetList : MetroWindow
    {
        ...
        private void initListView()
        {
            ...
            _listHeader.Clear();
                    ...
                    _listHeader.Add(new listHeader { h_width = 140, h_title = "M_Prop2_Name", h_bind = "location_name" });
                    _listHeader.Add(new listHeader { h_width = 320, h_title = "M_Prop1_3", h_bind = "location_path" });
                    _listHeader.Add(new listHeader { h_width = 140, h_title = "C_IP_Address", h_bind = "ipv4" });
                    _listHeader.Add(new listHeader { h_width = 200, h_title = "M_Prop1_1_Remarks", h_bind = "remarks" });
            ...
            for (int row = 0; row < _print_list.Count; row++)
            {
                ...
                for (int i = 0; i < _lvcompare.Count; i++)
                {
                    ...
                    switch (t1.newid)
                    {
                        ...
                        case 6: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.ipv4 == null ? "" : mp.ipv4)))); break;
                        case 7: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.remarks)))); break;
                    }
                }
            }
