...
namespace I2MS2
{
    ...
    /// </summary>
    public class PrintListProvider1 : IItemsProvider<locationView>
    {
        private readonly int _count;
        private readonly int _fetchDelay;
        private List<locationView> list1;
        ...
        public PrintListProvider1(int count, int fetchDelay)
        {
            _count = count;
            _fetchDelay = fetchDelay;
        }

        public PrintListProvider1(int p1, int p2, List<locationView> list1)
        {
        ...
        /// <returns></returns>
        public IList<locationView> FetchRange(int startIndex, int count)
        {
            ...
            try
            {
                ...
                if (t1 > _count)
                {
                    ...
                    {
                        locationView customer = new locationView { RowNumber = i };
                        list.Add(customer);
