...
namespace I2MS2.Windows
{
    ...
    /// </summary>
    public partial class ManufactureList : Window
    {
        ...
        private void initListView()
        {
            ...
            _listHeader.Add(new listHeader { h_width = 100, h_title = "C_No", h_bind = "RowNumber" });
            _listHeader.Add(new listHeader { h_width = 240, h_title = "M9_Manufacture_Name", h_bind = "manufacture_name" });
            ...
            _listHeader.Add(new listHeader { h_width = 320, h_title = "M9_Manufacture_Address", h_bind = "address" });
            _listHeader.Add(new listHeader { h_width = 280, h_title = "C_Homepage", h_bind = "homepage_url" });                  
            _listHeader.Add(new listHeader { h_width = 160, h_title = "C_Remarks", h_bind = "remarks" });
//            _listHeader.Add(new listHeader { h_width = 160, h_title = "C_Manager", h_bind = "contact_name" });                     
//            _listHeader.Add(new listHeader { h_width = 160, h_title = "M9_Contact_Duty", h_bind = "duty" });
//            _listHeader.Add(new listHeader { h_width = 160, h_title = "M9_Contact_Position", h_bind = "position" });
//            _listHeader.Add(new listHeader { h_width = 160, h_title = "M9_Contact_Phone", h_bind = "phone2" });
            // GS_DEL
