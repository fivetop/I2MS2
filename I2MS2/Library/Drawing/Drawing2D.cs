...
namespace I2MS2.Library.Drawing
{
    ...
    class Drawing2D
    {
        ...
        public void selectAsset(int id)
        {
            ...
            shadowEffect.Direction = 200;
            shadowEffect.ShadowDepth = 3;

            DrawingItem2DAsset ast = findAssetByID(id);
            ast._txtName.FontSize = 13;
        ...
        public void selectEditRack(int id)
        {
            ...
            if (_uc_rack != null)
            {
                _uc_rack.BorderThickness = new Thickness(2, 2, 2, 2);
                _uc_rack.BorderBrush = Brushes.Red;
//                _uc_rack._rectRack.BorderThickness = 2;        // romee 2018.03.19 통일 필요 
//                _uc_rack._rectRack.Stroke = Brushes.Red;
        ...
        public void releaseEditRack(int id)
        {
            ...
            if (_uc_rack != null)
            {
                _uc_rack.BorderThickness = new Thickness(0);
                _uc_rack.Effect = null;
                _uc_rack._txtName.FontSize = 11;
