...
namespace I2MS2.Windows
{
    public class EnvironmentPrintList : PropertyData
    {
        ...
        public Nullable<double> power_v { get; set; }
        public Nullable<double> power_v_cnt { get; set; }
        public Nullable<double> power_i { get; set; }
        public Nullable<double> power_i_cnt { get; set; }
        public Nullable<double> power_p { get; set; }
        public Nullable<double> power_p_cnt { get; set; }
        public Nullable<double> power_ph { get; set; }
        public Nullable<double> power_ph_cnt { get; set; }
        public Nullable<double> sensor_t { get; set; }
        public Nullable<double> sensor_t_cnt { get; set; }
        public Nullable<double> sensor_h { get; set; }
        public Nullable<double> sensor_h_cnt { get; set; }
        public Nullable<double> door { get; set; }
        public Nullable<double> smoke { get; set; }
        public Nullable<double> power_peek_v { get; set; }
        public Nullable<double> power_peek_i { get; set; }
        public Nullable<double> power_peek_p { get; set; }
        public Nullable<double> power_peek_ph { get; set; }
        public Nullable<double> sensor_peek_t { get; set; }
        public Nullable<double> sensor_peek_h { get; set; }
        public Nullable<double> alive { get; set; }
        public Nullable<double> powerwh { get; set; }
        public Nullable<double> powerwh_cnt { get; set; }
        public Nullable<double> powerday { get; set; }
        public Nullable<double> powerday_cnt { get; set; }
    }

    /// <summary>
    /// ManufactureManager.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class EnvironmentList : MetroWindow
    {
        ...
        private async Task<bool> getDBList()
        {
            ...
            var tdb1 = from b in eb_port_data_hour_list 
                       group b by new { b.date } into a
                       select new EnvironmentPrintList()
                       {
                           asset_id = a.First().asset_id,
                           asset_name = getAssetName(a.First().asset_id),
                           date = a.Key.date.ToShortDateString(),
                           install_date = a.Key.date,
                           time_0_23 = 0,
                           power_ph = getdouble(a.Sum(c => c.power_ph), a.Sum(c => c.power_ph_cnt)),
                           power_p = getdouble(a.Sum(c => c.power_p), a.Sum(c => c.power_p_cnt)),
                           power_i = getdouble(a.Sum(c => c.power_i), a.Sum(c => c.power_i_cnt)),
                           power_v = getdouble(a.Sum(c => c.power_v), a.Sum(c => c.power_v_cnt)),
                           powerwh = getdouble(a.Sum(c => c.powerwh), a.Sum(c => c.powerwh_cnt)),
                           powerday = getdouble(a.Sum(c => c.powerday), a.Sum(c => c.powerday_cnt)),
                           sensor_t = getdouble(a.Sum(c => c.sensor_t), a.Sum(c => c.sensor_t_cnt)),
                           sensor_h = getdouble(a.Sum(c => c.sensor_h), a.Sum(c => c.sensor_h_cnt)),
                           door = a.Sum(c => c.door),
                           smoke = a.Sum(c => c.smoke),
                           last_updated = a.First().last_updated,
                           RowNumber = i++,
                           last_updated_string = a.First().last_updated.ToShortDateString(),
                       };
        ...
        private double? getdouble(int? a1, int? a2)
        {
            double d1 = 0;
            double d2 = a1 ?? 0;
            double d3 = a2 ?? 0;
        ...
        private void initListView()
        {
            ...
            _listHeader.Add(new listHeader { h_width = 120, h_title = "C_Power", h_bind = "power_p" });
            _listHeader.Add(new listHeader { h_width = 120, h_title = "D_Stat21", h_bind = "power_v" });
            _listHeader.Add(new listHeader { h_width = 120, h_title = "D_Stat22", h_bind = "power_i" });
            _listHeader.Add(new listHeader { h_width = 120, h_title = "D_Stat24", h_bind = "power_ph" });
            _listHeader.Add(new listHeader { h_width = 120, h_title = "D_Stat25", h_bind = "powerday" });
            ...
            _listHeader.Add(new listHeader { h_width = 120, h_title = "D_Stat23", h_bind = "smoke" });
