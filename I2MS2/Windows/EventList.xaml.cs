...
//            _sel_option1.Add("Warning");
            _sel_option1.Add("Error");
            _sel_option1.Insert(0, "--All Field (default)--");
        ...
        private void initListView()
        {
            ...
            switch (cboType2.SelectedIndex)
            {
                ...
                case 3:
                    ...
                    _listHeader.Add(new listHeader { h_width = 150, h_title = "C_Date", h_bind = "write_time" });
                    ...
                    _listHeader.Add(new listHeader { h_width = 120, h_title = "M9_UserManager_LoginID", h_bind = "user_name" });
                    _listHeader.Add(new listHeader { h_width = 120, h_title = "C_Name1", h_bind = "confirm_user_name" });
                    break;
            }
...
*/
            ...
            for (int row = 0; row < _print_list.Count; row++)
            {
                ...
                for (int i = 0; i < _lvcompare.Count; i++)
                {
                    ...
                    switch (t1.newid)
                    {
                        ...
                        case 10: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.user_name)))); break;
                        case 11: ip.r1.Cells.Add(new TableCell(new Paragraph(new Run(mp.confirm_user_name)))); break;
                    }
                }
            }
        ...
        // 자산명 검색 처리 
        private async void _btnSearch1_Click(object sender, RoutedEventArgs e)
        {
            this.Cursor = Cursors.Wait;
            ...
            var tdb1 = from a in g.event_hist_list
                       ...
                       orderby a.write_time descending
                       select new EventPrintList()
                       {
                           RowNumber = i++,
                           ...
                           is_confirm = a.is_confirm,
                           confirm_user_id = a.confirm_user_id,
                           confirm_user_name = getUserName(a.confirm_user_id),
                           write_time = a.write_time == null ? "" : string.Format("{0}", a.write_time.ToString("yyyy-MM-dd HH:mm:ss")),
                           wo_id = a.wo_id,
...
//                    tdb1 = tdb1.Where(a => a.event_type == "Warning"); break;
        ...
        private string getUserName(int? id)
        {
            ...
            if (a1 != null)
            {
                ret = string.Format("{0}", a1.login_id);
            }
            return ret;
        }
