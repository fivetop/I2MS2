...
namespace I2MS2.Windows
{
    ...
    /// </summary>
    public partial class LocationList : MetroWindow
    {
        ...
        private void _window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            // Data Binding
            PrintListProvider1 dProvider = new PrintListProvider1(_print_list.Count, 1000, _print_list);
            _lvManufacture.ItemsSource = new VirtualizingCollection<locationView>(dProvider, 100);
            try
            {
